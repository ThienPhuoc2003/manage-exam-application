...
const GiaoVuKhoaLogin: React.FC<LoginFormProps> = ({ currentUser }) => {
  ...
  useEffect(() => {
    if (currentUser && currentUser.role === "GIAOVUKHOA") {
      router.push('/giaovukhoa');
      router.refresh();
    }
  }, [currentUser, router]);
  ...
  return (
    <>
        <Heading title="Xin mời Giáo vụ khoa đăng nhập:" />
...
export default GiaoVuKhoaLogin;